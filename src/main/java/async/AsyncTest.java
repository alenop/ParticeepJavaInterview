...
class AsyncTest {
  ...
  public static CompletableFuture<Option<Ceo>> getCeoById(String ceo_id) {
    CompletableFuture<Option<Ceo>> result;
    for (Ceo ceo : ceos) {

      if (ceo.id == ceo_id) {
        result = Future.of(() -> Option.of(ceo)).toCompletableFuture();
        return result;
      }
    }
    result = Future.of(() -> Option.of((Ceo) null)).toCompletableFuture();
    return result;
  }

  public static CompletableFuture<Option<Enterprise>> getEnterpriseByCeoId(String ceo_id) {
    CompletableFuture<Option<Enterprise>> result;
    for (Enterprise enterprise : enterprises) {

      if (enterprise.ceo_id == ceo_id) {
        result = Future.of(() -> Option.of(enterprise)).toCompletableFuture();
        return result;
      }
    }
    result = Future.of(() -> Option.of((Enterprise) null)).toCompletableFuture();
    return result;
  }
  ...
  public static CompletableFuture<Tuple2<Option<Ceo>, Option<Enterprise>>> getCEOAndEnterprise(String ceo_id) {
    ...
    CompletableFuture<Tuple2<Option<Ceo>, Option<Enterprise>>> result = Future.of(() -> Tuple.of(ceo, enterprise))
        .toCompletableFuture();
    return result;
